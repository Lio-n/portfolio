<script>
  ...
  /**
   * @param {Element | SVGPathElement} node
   * @param {{ duration: any; delay: any; easing: any; }} params
   */
...
<button on:click={() => (condition = !condition)} class="text-nero"> show svg </button>
...
{#if condition}
  <svg width="98" height="96" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"
    ><path
