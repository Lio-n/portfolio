...
const general_works: Work[] = [
  ...
  {
    title: "Portafolio desafío",
    description:
      "Para este Desafio, cree este Portafolio en el cual utilize la Api de ContentFul para gestionar el contenido. Con este Desafio siento que mejore mucho con HTML, CSS y JavaScript.",
    repository_url: "https://github.com/Lio-n/dwf-m4-desafio-portafolio",
    site_url: "https://lio-n.github.io/dwf-m4-desafio-portafolio",
  },
  {
    title: "SPA : App piedra, papel o tijera V1",
    description: "Para este Desafio, cree este juego piedra, papel o tijera single-player.",
  ...
  {
    title: "SPA : App piedra, papel o tijera V2",
    description: "Para este Desafio creo una App piedra, papel o tijera multi-player.",
...
const frontend_mentor_works: Work[] = [
  ...
  },
  {
    ...
    description: "Para más detalles en el README.md",
